...
(() => {
  ...
  try {
    ...
    if (filteredRootDependencies.length > 0) {
      ...
      console.log(`${chalk.whiteBright.bgYellow.bold('Webpack does not work with native dependencies.')}
...
Read more about native dependencies at:${chalk.bold('https://github.com/chentsulin/electron-react-boilerplate/wiki/Module-Structure----Two-package.json-Structure')}`);
