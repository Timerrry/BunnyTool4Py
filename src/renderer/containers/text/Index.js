...
import { setBoards, setPorts, setExamples } from '../../reducers/text/config';
...
class Index extends Component {
  ...
  _handleNewFile() {
	...
	_handleRemoveFile() {
		...
		Modal.confirm({
			title: '删除文件',
			content: `确定要删除文件“${curFile.name}”吗？`,
			okText: '确定',
			okType: 'danger',
			cancelText: '取消',
			onOk() {
  ...
  render() {
    ...
    return (
      <TextCoder
        ...
        header={
          <Header>
            <ProjectName projectName={projectName} projectPath={projectPath} onProjectNameChange={::this._handleProjectNameChange} />
          </Header>
        }
        topMenu={
					<TopMenu
