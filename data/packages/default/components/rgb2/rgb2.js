...
Blockly.Blocks.extensions.list_rgb2 = function() {
  return Blockly.Blocks.extensions.genComponentOptions("rgb2", [["三色LED", "三色LED"]]);
}
...
Blockly.Blocks.ext_rgb2_turn_on = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown(Blockly.Blocks.extensions.list_rgb2), 'RGB')
        .appendField(Blockly.Msg.ARD_EXT_RGB_TO)
        .appendField(new Blockly.FieldDropdown([
          [Blockly.Msg.ARD_EXT_RGB_WHITE, '0,0,0'], 
          [Blockly.Msg.ARD_EXT_RGB_YELLOW, '0,0,255'], 
          [Blockly.Msg.ARD_EXT_RGB_ORANGE, '55,205,255'], 
          [Blockly.Msg.ARD_EXT_RGB_RED, '0,255,255'], 
          [Blockly.Msg.ARD_EXT_RGB_DARKGREEN, '255,195,153'], 
          [Blockly.Msg.ARD_EXT_RGB_BLUE, '215,215,0'], 
          [Blockly.Msg.ARD_EXT_RGB_DARKBLUE, '255,255,0'], 
          [Blockly.Msg.ARD_EXT_RGB_PINK, '0,255,0']
        ]), 'COLOR')
...
Blockly.Arduino.ext_rgb2_turn_on = function(block) {
  var rgb2 = block.getFieldValue('RGB');
  var color = block.getFieldValue('COLOR');

  var config = Blockly.Blocks.extensions.getConfig("rgb2", rgb2);
  ...
  var varName = rgb2.replace(/^(.*)-(\d+)$/, "rgb2_$2");
...
Blockly.Blocks.ext_rgb2_turn_off = {
  init: function() {
    this.setHelpUrl('http://arduino.cc/en/Reference/noTone');
    this.setColour(Blockly.Blocks.extensions.RGB_HUE);
...
Blockly.Arduino.ext_rgb2_turn_off = function(block) {
  var rgb2 = block.getFieldValue('RGB');
  var color = block.getFieldValue('COLOR');
  ...
  var colorSetupCode = varName + '.setRGBcolor(255, 255, 255);\n';
  // Blockly.Arduino.addSetup('io_' + pin_r, colorSetupCode, false);
...
Blockly.Blocks.ext_rgb2_set_redcolor = {
  init: function() {
...
Blockly.Arduino.ext_rgb2_set_redcolor = function(block) {
  var rgb2 = block.getFieldValue('RGB');
...
Blockly.Arduino.ext_rgb2_fade = function(block) {
  var rgb2 = block.getFieldValue('RGB');
  var rgb_r = block.getFieldValue('RGB_R');
  var rgb_g = block.getFieldValue('RGB_G');
  var rgb_b = block.getFieldValue('RGB_B');
